...
| **[Built-in Resource](src/main/java/decok/dfcdvadstf/catframe/resources/builtin)** | `BuiltinPackDescriptor`, `BuiltinPackInjector` | Modern feelings of the registering built-in resource packs. |
