...
public class Text {
     ...
     * of {@link #fromJson(String)}. The output conforms to the standard Minecraft raw
     * JSON text format and can be round-tripped through {@code fromJson}.
     * <p>将本 Text 树序列化回原始 JSON 文本组件字符串 —— {@link #fromJson(String)} 的
     * 逆操作。输出符合标准 Minecraft 原始 JSON 文本格式，可经 {@code fromJson} 往返还原。</p>
     */
